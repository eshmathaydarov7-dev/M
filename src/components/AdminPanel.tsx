...
import { Plus, Trash, RotateCcw, Database, ShieldAlert, Sparkles, BookOpen, AlertTriangle, Check } from "lucide-react";
...
export default function AdminPanel({ books, transactions, onAddBook, onDeleteBook, onResetDatabase, onClose }: AdminPanelProps) {
  ...
  return (
    <div className="bg-slate-900 border border-slate-700/80 rounded-2xl p-6 shadow-2xl max-w-5xl mx-auto space-y-8" id="admin-panel-container">
      {/* Top Header section */}
      <div className="flex justify-between items-center border-b border-slate-800 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Kitoblar zaxirasi inventarizatsiyasi va boshqaruv asboblar paneli</p>
          </div>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="bg-slate-800 hover:bg-slate-700 text-slate-300 px-2 rounded-lg text-xs border border-slate-700"
        ...
        <div className="bg-slate-950/40 border border-slate-800/80 p-5 rounded-xl lg:col-span-2 flex flex-col justify-between space-y-4">
          ...
          <div className="bg-red-950/20 border border-red-900/35 p-3.5 rounded-xl space-y-2 mt-4 animate-pulse">
